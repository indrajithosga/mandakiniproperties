            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="../SalesRep/ViewSalesRep.jsp">View SalesRep</a></li>
                    </ol>
                </section>
                <!-- Main content -->
                <section class="content">
                    <form action="../../addsalesrep" method="post">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control my-colorpicker1 required" id="salrpfname" name="salrpfname" placeholder="Enter First name">
                                        ...
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control my-colorpicker1 required" id="salrplname" name="salrplname" placeholder="Enter Last name">
                                        ...
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control my-colorpicker1 required" id="salrpnic" name="salrpnic" placeholder="Enter NIC number">
                                         ...
                                         <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control my-colorpicker1 required" id="salrpmnumber" name="salrpmnumber" placeholder="Enter NIC number">
										...
										<div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control my-colorpicker1 required" id="salrpemail" name="salrpemail" placeholder="Enter Email">
                                         ...
                                         <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control my-colorpicker1 required" id="salrpjoindate" name="salrpjoindate" placeholder="YYYY/MM/DD">
                                ...
                                <div class="box box-warning">
                                    ...
                                    <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control required" rows="4" id="salrpaddress" name="salrpaddress" placeholder="Enter Address"></textarea>
                        ...
                        <div class="form-group">
                            <input type="submit" class="btn btn-primary required" value="AddSalesRep" name="add"/>
