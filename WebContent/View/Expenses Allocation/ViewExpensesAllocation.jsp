<%@page import="com.manda.dataAccess.ExpensesAllocationDataAccess"%>
<%@page import="com.manda.entity.ExpensesAllocation"%>
...
<html>
    <head>
        ...
        <title>View Expenses Allocation</title>
...
<%
	...
	List<ExpensesAllocation> allExpensesAllocation=ExpensesAllocationDataAccess.getAllExpensesAllocation();
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                	...
                	<h1 style="text-align: center;padding-bottom: 0em;font-family: serif;font-size: x-large;font-weight: bold;">
                        Mandakini Properties Pvt Ltd.
                        
                    </h1>
                
                    <h4 style="text-align: center;padding-bottom: 0.2em;font-family: serif;font-size: large;">
                        Budget Allocation For Land Development
                        
                    </h4>
                   <ol class="breadcrumb">
                        <li><a href="../Dashboard/DashBoard.jsp"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active"><a href="../Expenses Allocation/AddExpensesAllocation.jsp">Add Expenses Allocation</a></li>
                    </ol>
                </section>
                <!-- Main content -->
							...
							<div class="col-md-4">
								...
								<div class="box box-primary">
									...
									<div class="box-body">
										...
										<div class="form-group">
                                            <div class="form-group">
                                                <label>Remaining Balance Date:</label>
                                                <input type="date" class="form-control my-colorpicker1 required" id="reminbaladate" name="reminbaladate" placeholder="YYYY/MM/DD">
                                                <span id="msgreminbaladate"  style="color: #ff0000">
                                            </div>
                                        </div>
					...
					<div class="box box-primary">
                        ...
                        <table class="table table-striped">
							...
							<%
								...
								for(ExpensesAllocation expensesAllocation:allExpensesAllocation){
                            ...
                            <tr>
                                ...
                                <td><button class="btn btn-default btn-sm">
                                    ...
                                    <button class="btn btn-warning btn-sm">
                                        <a href="UpdateUser.jsp?user_id=&action=update">
                                            <i class="glyphicon glyphicon-edit"></i>
                                        </a>
                                    </button>
                                    <button class="btn btn-danger btn-sm"><a href="" onclick="userdelete()" data-toggle="modal" data-target="#deleteModal"><i class="glyphicon glyphicon-trash"></i></a></button>
                                </td>
