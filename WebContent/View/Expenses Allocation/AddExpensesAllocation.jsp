...
<html>
    <head>
        ...
        <title>ADD EXPENSES ALLOCATION FOR PROJECTS</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Add Expenses Allocation For Projects
                        
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="../Dashboard/DashBoard.jsp"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active"><a href="../Expenses Allocation/ViewExpensesAllocation.jsp">View Expenses Allocation</a></li>
                    </ol>
                </section>
                <!-- Main content -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="box box-warning">
                                            <div class="box-header" >
                                                <h3 class="box-title">Expenses Informations</h3>
                                            </div>
                                            ...
                                            <div class="box-body" style="height:230px;">
                                                ...
                                                <div class="col-md-4" style="margin-left: 0px;padding-left: 0px">
                                                    ...
                                                    <div style="float: left;width: 60px;margin-top: -2px;margin-left: 4px">Total</div>
                                                </div>
                                                <div class="col-md-4" style="margin-left: 0px;padding-left: 0px">
                                                    <div style="float: left;width: 15px;"><p style="height: 15px;width: 15px;background-color: #FF9E01"></p></div>
                                                    <div style="float: left;width: 60px;margin-top: -2px;margin-left: 4px">Expe.Amount</div>
                                                </div>
                                                <div class="col-md-4" style="margin-left: 0px;padding-left: 0px">
