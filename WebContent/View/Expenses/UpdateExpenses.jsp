...
<head>
  ...
  <%
  	...
  	Expenses expenses=ExpensesDataAccess.getExpenses(expensesId);
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="row">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control my-colorpicker1 required" id="exname" name="exname" value="<%=expenses.getExpName()%>" placeholder="Enter Expenses Name">
                                        ...
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control my-colorpicker1 required" id="exremark" name="exremark" value="<%=expenses.getExpRemark()%>" placeholder="Enter Expenses Remark">
                        ...
                        <div class="form-group">
                            <input type="submit" class="btn btn-primary required" value="UpdateExpenses" name="add"/>
